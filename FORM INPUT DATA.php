...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['foto']) && $_FILES['foto']['error'] == 0) {
        $targetDir = "image"; // Folder untuk menyimpan foto (buat folder ini di direktori yang sama)
    ...
    echo "Nama: Meyla Shafa  Rizkianti <br>";
    echo "Alamat: Simojawar <br>";
    echo "Tanggal Lahir: 18 <br>";
    echo "Bulan Lahir: Mei <br>";
    echo "Tahun Lahir:2005 <br>";
    if ($foto) {
